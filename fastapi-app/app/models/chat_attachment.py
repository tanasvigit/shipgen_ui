...
class ChatAttachment(Base):
    ...
    sender_uuid: Mapped[Optional[str]] = mapped_column(String(36), index=True, nullable=True)
    file_uuid: Mapped[Optional[str]] = mapped_column(String(36), index=True, nullable=True)
