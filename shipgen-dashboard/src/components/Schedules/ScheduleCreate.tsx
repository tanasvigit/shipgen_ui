    ...
    <div className="space-y-6">
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">POST /int/v1/schedules</p>
        </div>
      </div>

      <div className="rounded-xl border border-gray-200 bg-white p-6">
        <ScheduleForm mode="create" onCancel={() => navigate('/analytics/schedules')} onSuccess={() => navigate('/analytics/schedules')} />
      </div>
    </div>
  );
};
